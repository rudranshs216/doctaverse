...
const AppOne = () => {
    return (
        <div className='h-full py-10 lg:py-20 w-full flex flex-col justify-around items-center lg:h-full lg:flex-row'>
            <img className='w-[500px]' src="https://themes.stackbit.com/demos/app/images/feature-1.svg" />
            <div className="w-[100%] mt-10 p-4 sm:w-[500px] lg:mt-0">
                ...
                <button className='px-6 py-3 bg-[#0084ff] text-white rounded my-5  hover:bg-black'>Learn More</button>
